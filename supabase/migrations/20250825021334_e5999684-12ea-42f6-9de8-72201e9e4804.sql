...
INSERT INTO public.clients (name, created_by, updated_by) VALUES 
('ExampleCorp', (SELECT id FROM auth.users LIMIT 1), (SELECT id FROM auth.users LIMIT 1)),
('TechStartup Inc.', (SELECT id FROM auth.users LIMIT 1), (SELECT id FROM auth.users LIMIT 1)),
('Government Agency', (SELECT id FROM auth.users LIMIT 1), (SELECT id FROM auth.users LIMIT 1))
